...
namespace Core3lb
{
    //Line Arc is utility for working with the Unity LineRenderer It can create straight and curved lines between two points
    ...
    public class LineArcSystem : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            myLine = gameObject.GetComponentIfNull<LineRenderer>(myLine);
